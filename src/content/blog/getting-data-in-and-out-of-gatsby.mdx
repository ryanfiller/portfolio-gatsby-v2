...
I'm far from an SEO expert, but I do know that having the same content live on multiple urls across the web can somtimes confuse search engines. For this situation exactly, a `rel="canonical"` link can be added to any syndicated posts and point back to the main blog domain. This [Google Webmaster article](https://support.google.com/webmasters/answer/139066?hl=en) does a pretty good job elaborting exactly why this is important.