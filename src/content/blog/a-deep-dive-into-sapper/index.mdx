...
MDsveX can also be configured with a module script in each layout to take an object of components that will automatically be replaced when the corresponding HTML is rendered in the Markdown generated by that layout.
